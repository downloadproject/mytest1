...
// configuration step. It creates a namespace called `mytest1`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", mytest1::cmake::project_name, mytest1::cmake::project_version) };
